...
import { Trophy, ExternalLink, Github, Download } from 'lucide-react';
...
const placeholderProjects: Project[] = [
    {
        ...
        description: "My first major React project - this website! Built with React, TypeScript, and Tailwind CSS",
        projectUrl: "#"
    },
    {
        id: 2,
        title: liveScoreProject.name,
        description: liveScoreProject.description,
        projectUrl: liveScoreProject.live_demo || "#"
    },
    {
        id: 3,
        title: fxtcherProject.name,
        description: fxtcherProject.description,
        projectUrl: fxtcherProject.live_demo || "#"
    },
    {
        id: 4,
        title: "Open to Collaborate",
        description: "Interested in contributing to open source projects and learning from other developers",
        projectUrl: "#"
    },
];

const App: React.FC = () => {
    const [projects] = useState<Project[]>(placeholderProjects);
            ...
            <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-4">
                <nav className="flex justify-center items-center relative">
                    <div className="flex space-x-4 justify-center">
                        ...
                        <Link to="/projects" className="hover:text-accent-yellow transition-colors px-2 sm:px-6 text-sm sm:text-base font-bold">Projects</Link>
...
const ProjectCard: React.FC<{ project: Project; darkMode: boolean; cardVariants: any }> = ({ project, darkMode, cardVariants }) => (
    <Link to={project.id === 2 || project.id === 3 ? "/projects" : project.projectUrl}>
        <motion.div
            className={`${darkMode ? 'bg-dark-card' : 'bg-light-card'} rounded-3xl p-6 col-span-1 h-64 flex flex-col cursor-pointer`}
            variants={cardVariants}
            initial="initial"
            animate="animate"
            whileHover="hover"
        >
            {project.id === 2 ? (
                <>
                    ...
                    <div className="mt-auto">
                        <div className="flex gap-2 text-sm">
                            <span className="text-accent-yellow font-medium">React</span>
                            <span className="text-accent-yellow/20">•</span>
                            <span className="text-accent-yellow font-medium">TypeScript</span>
                        </div>
                    </div>
                </>
            ) : project.id === 3 ? (
                <>
                    ...
                    <div className="mt-auto">
                        <div className="flex gap-2 text-sm">
                            <span className="text-accent-yellow font-medium">React</span>
                            <span className="text-accent-yellow/20">•</span>
                            <span className="text-accent-yellow font-medium">Flask</span>
                        </div>
                    </div>
                </>
            ) : (
                <>
                    ...
                    <p className={`${darkMode ? 'text-gray-300' : 'text-gray-700'} text-base mb-4 line-clamp-3`}>{project.description}</p>
                    <div className="mt-auto">
                        <span className="text-accent-yellow hover:underline flex items-center justify-end text-sm group">
                            View Project
